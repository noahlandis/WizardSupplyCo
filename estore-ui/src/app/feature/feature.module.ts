...
@NgModule({
    declarations: [TestCartComponent, TestAdminDashboardComponent, TestCatalogComponent, LoginRegistrationComponent, EditProductComponent, CreateProductComponent, CatalogProductCardComponent],
    imports: [
        CommonModule,
        MaterialModule,
        ReactiveFormsModule
